...
> **0.9.4 版本边界**：保存 commit `eb750a8`，标签 `demo-app-v0.9.4`（远端状态以 Git 实测为准）
> **上一保存版本**：`0.9.3 / versionCode 14`（commit `1170268`，标签 `demo-app-v0.9.3`，正式保存条目见版本台账）
> **再上一保存版本**：`0.9.2 / versionCode 13`，标签 `demo-app-v0.9.2`
...
> **当前版本标签**：`demo-app-v0.9.4`；`0.9.3` 保存点标签为 `demo-app-v0.9.3`（指向 `1170268`）（远端状态以 Git 实测为准）
