...
更新时间：2026-08-30
当前版本：`0.9.1`（`versionCode 12`）；本文只定义聊天与悬浮窗 UI 基线，版本交付证据以 `demo-app-version-ledger.md` 为准。
`0.9.1` 是 API 24 文件边界与 Intent data/type 稳定性 patch，不改变本文件的聊天、过程或悬浮窗视觉契约；设备与 skill 行为边界以版本台账当前条目为准。
